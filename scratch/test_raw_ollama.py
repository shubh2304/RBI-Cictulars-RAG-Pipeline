...
# Format the contexts exactly as LLMClient does
context_str = ""
...
req = urllib.request.Request("http://localhost:11434/v1/chat/completions", data=req_data, headers={"Content-Type": "application/json"}, method="POST")
...
try:
    with urllib.request.urlopen(req) as r:
        ...
        with open("scratch/ollama_output.json", "w", encoding="utf-8") as f:
            f.write(content)
        print("SUCCESS: Raw Ollama response saved to scratch/ollama_output.json")
